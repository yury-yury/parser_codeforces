...
from parcer_2.settings import TG_TOKEN
...
class TgClient:
    ...
    def get_updates(self, offset: int = 0, timeout: int = 60) -> GetUpdatesResponse:
        ...
        response: requests.Response = requests.get(url, params={"offset": offset, "timeout": timeout})
    ...
    def send_message(self, chat_id: int, text: str) -> SendMessageResponse:
        ...
        response: requests.Response = requests.post(url, params={"chat_id": chat_id, "text": text})
